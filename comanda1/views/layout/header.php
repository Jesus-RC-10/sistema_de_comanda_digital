        ...
        <div class="sidebar">
            <ul class="sidebar-menu">
                ...
                <li class="menu-item" data-section="mesas">
                    <a href="index.php?seccion=mesas">🪑 Gestión de Mesas</a>
                </li>
                <li class="menu-item" data-section="menu">
                    <a href="index.php?seccion=menu">🍽️ Gestión de Menú</a>
                </li>
                <li class="menu-item" data-section="usuarios">
                    <a href="index.php?seccion=usuarios">👥 Gestión de Usuarios</a>
                </li>
                <li class="menu-item" data-section="inventario">
                    <a href="index.php?seccion=inventario">📦 Control de Inventario</a>
                </li>
                <li class="menu-item" data-section="reportes">
                    <a href="index.php?seccion=reportes">📊 Reportes</a>
                </li>
            </ul>
        </div>
